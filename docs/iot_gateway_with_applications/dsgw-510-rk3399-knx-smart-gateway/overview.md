...
- **All-round connectivity: Covers Ethernet, KNX, WiFi, LTE, RS485/232, M-Bus, CAN, and optional BLE/ZigBee/Z-wave for diverse device access.
- **Flexible expandability: Left-side wireless module expansion and right-side IO interface expansion to meet customized needs.
- **Broad compatibility: Supports multiple OS (Debian12, Ubuntu18.04, Android10.0, Buildroot+QT) and IEEE802.11 series WiFi standards.
- **Reliable & easy-to-use: Rail-mounted installation, -40℃~85℃ storage temp range, and clear LED status indicators for stable operation in smart scenarios.
...
<div class="custom-links">
  <a href="https://wiki.dusuniot.com/iot_gateway_with_applications/dsgw-510-rk3399-knx-smart-gateway/specification">Specification</a>
  <a href="https://wiki.dusuniot.com/iot_gateway_with_applications/dsgw-510-rk3399-knx-smart-gateway/quick-start-guide">Quick Start Guide</a>
</div>
...
| Firmware | Resources |
|-----|-----|
| Firmware Packaging | [Download](https://drive.google.com) |
| SDK | [Download](https://drive.google.com) |

| Tools | Resources |
|-----|-----|
| Burning tools | [Download](https://drive.google.com) |
| Driver | [Download](https://drive.google.com) |
